        ...
        <div className=" h-full w-full flex items-center">
          <div className="pt-10 w-full ">
            ...
            <div className="flex justify-center md:justify-start items-start">
              <Link
                to="/realizacje"
                className="mt-7 px-3 py-2 md:px-5 md:py-3 text-center justify-center rounded-full border-white/20 border-2 text-white/80 text-xs md:text-base font-normal "
              >
