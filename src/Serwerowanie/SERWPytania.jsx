...
function SERWPytania({ onClick }) {
  return (
    <div className="flex flex-col h-[300px] justify-end pb-16">
      <h2 className="text-center text-4xl md:text-6xl">Masz pytania?</h2>
      <Link
        to="/kontakt"
        className="px-2 py-3 mt-10 flex justify-center items-center border-2 border-black/40 rounded-full"
