...
export default function WManOffer() {
  ...
  return (
    <section className=" w-[95%] py-12 md:px-12  lg:bg-white rounded-2xl">
      <h2 className="text-center text-4xl  mb-8">Porównaj Ofertę:</h2>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
        {plans.map((plan, index) => (
          ...
          >
            <div>
              <h3 className="text-xl md:text-2xl  mb-6">{plan.title}</h3>
              <p className="text-black/70 mb-16">{plan.price}</p>
              <ul className="text-xs md:text-sm text-black/60 space-y-2">
