...
const projects = [
  {
    ...
    content:
      "Nasza firma potrzebowała nowoczesnej, intuicyjnej strony, która ułatwi klientom dostęp do informacji o naszych realizacjach i usługach. Nowa witryna jest przejrzysta, szybka i profesjonalna – dokładnie tak, jak nasza praca.", // null oznacza, że pokazujemy logo i tytuł
  },
  {
    id: 2,
    title: "",
...
const RECardKasp = () => {
  ...
  const handleClick = () => {
    window.open("https://bdkasprzak.pl/", "_blank");
  };
